...
(5, 'USB Flash', 'portable storage device'),
...
(1, 'John', 'Chen', 'Senior Programmer', 31, 3, 120000, 25000, 'j@hotmail.com', 'DP01'),
(2, 'Jan', 'Pillai', 'Senior Programmer', 32, 4, 110000, 20000, 'g@yahoo.com', 'DP05'),
(3, 'Ane', 'Pandit', 'Web Designer', 24, 3, 90000, 15000, 'a@gmail.com', 'DP05'),
(4, 'Mary', 'Anchor', 'Web Designer', 27, 2, 85000, 15000, 'm@mail.com', NULL),
(5, 'Fred', 'King', 'Programmer', 32, 3, 75000, 15000, 'f@net.com', 'DP07'),
(6, 'John', 'Mac', 'Programmer', 32, 4, 80000, 16000, 'j@hotmail.com', 'DP01'),
(7, 'Arthur', 'Sam', 'Programmer', 28, 2, 75000, 14000, 'e@yahoo.com', 'DP02'),
(8, 'Alok', 'Nanda', 'Programmer', 32, 3, 70000, 10000, 'a@yahoo.com', NULL),
(9, 'Susan', 'Ra', 'Multimedia Programmer', 32, 4, 90000, 15000, 'h@gmail.com', 'DP01'),
(10, 'Paul', 'Simon', 'Multimedia Programmer', 23, 1, 85000, 12000, 'ps@gmail.com', 'DP03'),
...
(65, 'angkor', 'mm', 20.000, 32, NULL, 4, NULL);
...
INSERT INTO `tblcareer` (`careerid`, `career`, `salary`, `retiredage`, `descrition`) VALUES
(1, 'Police', 200.000, 60, 'Police officer'),
(2, 'Teacher', 210.000, 65, 'High school teacher'),
(3, 'Doctor', 320.000, 55, 'Gend doctor'),
(4, 'Farmer', 0.000, 0, 'Not limited to anyone'),
(5, 'Business Man', 0.000, 0, 'For everyone');
...
(1, 'Phnom Penh', 'ភ្នំពេញ', b'1111111111111111111111111111111'),
(2, 'Battambang', 'បាត់ដំបង', b'1111111111111111111111111111111'),
(3, 'Banteay Meanchey', 'បន្ទាយមានជ័យ', b'1111111111111111111111111111111'),
(4, 'Kampong Cham', 'កំពង់ចាម', b'1111111111111111111111111111111'),
(5, 'Kampong Chhnang', 'កំពង់ឆ្នាំង', b'1111111111111111111111111111111'),
(6, 'Kampong Speu', 'កំបង់ស្ពឺ', b'1111111111111111111111111111111'),
(7, 'Kampong Thom', 'កំពង់ធំ', b'1111111111111111111111111111111'),
(8, 'Kampot', 'កំពត', b'1111111111111111111111111111111'),
(9, 'Kandal', 'កណ្តាល', b'1111111111111111111111111111111'),
(10, 'Koh Kong', 'កោះកុង', b'1111111111111111111111111111111'),
(11, 'Kratié', 'ក្រចេះ', b'1111111111111111111111111111111'),
(12, 'Mondulkiri', 'មណ្ឌលគិរី', b'1111111111111111111111111111111'),
(13, 'Oddar Meancheay', 'ឧត្តរមានជ័យ', b'1111111111111111111111111111111'),
(14, 'Preah Vihear', 'ព្រះវិហារ', b'1111111111111111111111111111111'),
(15, 'Pursat', 'ពោធិ៍សាត់', b'1111111111111111111111111111111'),
(16, 'Prey Veng', 'ព្រៃវែង', b'1111111111111111111111111111111'),
(17, 'Ratanakiri', 'រតនៈគិរី', b'1111111111111111111111111111111'),
(18, 'Siem Reap', 'សៀមរាប', b'1111111111111111111111111111111'),
(19, 'Stung Treng', 'ស្ទឹងត្រែង', b'1111111111111111111111111111111'),
(20, 'Svay Rieng', 'ស្វាយរៀង', b'1111111111111111111111111111111'),
(21, 'Takéo', 'តាកែវ', b'1111111111111111111111111111111'),
(22, 'Kep', 'កែប', b'1111111111111111111111111111111'),
(23, 'Pailin', 'ប៉ៃលិន', b'1111111111111111111111111111111'),
(24, 'Preah Sihanouk', 'ព្រះសីហនុ', b'1111111111111111111111111111111');
...
--
ALTER TABLE `sales`
  MODIFY `salesid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1001;
...
--
-- AUTO_INCREMENT for table `tblprovinces`
--
ALTER TABLE `tblprovinces`
