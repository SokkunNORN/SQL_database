...
-- Dumping database structure for pnc
DROP DATABASE IF EXISTS `pnc_store`;
CREATE DATABASE IF NOT EXISTS `pnc_store` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `pnc_store`;


-- Dumping structure for table pnc.category
...
-- Dumping data for table pnc.category: ~14 rows (approximately)
...
-- Dumping structure for table pnc.employee
...
-- Dumping data for table pnc.employee: ~22 rows (approximately)
...
-- Dumping structure for table pnc.location
...
-- Dumping data for table pnc.location: ~3 rows (approximately)
...
-- Dumping structure for table pnc.product
...
-- Dumping data for table pnc.product: ~65 rows (approximately)
...
-- Dumping structure for table pnc.sales
...
-- Dumping data for table pnc.sales: ~1,000 rows (approximately)
...
-- Dumping structure for table pnc.store
...
-- Dumping data for table pnc.store: ~4 rows (approximately)
...
-- Dumping structure for table pnc.users
...
-- Dumping data for table pnc.users: ~21 rows (approximately)
